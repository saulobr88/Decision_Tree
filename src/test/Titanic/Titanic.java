...
public class Titanic {
	...
	public static void main(String[] args) throws FileNotFoundException, IOException {
        ...
        FileWriter fileWriter = new FileWriter(new File("predictions_titanic.csv"));
	...
	private static List<DataSample> readData(boolean training) throws IOException {
		...
		InputStreamReader stream = new InputStreamReader(Titanic.class.getResourceAsStream(filename));
